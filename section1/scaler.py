...
class CustomGradScaler:
        ...
        if self.scaled_state:
            ...
            for group in optimizer.param_groups.values():
                for param in group:
                    ...
                    self.found_bad_param = self.found_bad_param or not torch.isfinite(param.grad)
    ...
    def update(self) -> None:
        wandb.log({"section1/gradient scaling factor": self.scale_factor}, step=wandb.step)
